  ...
  return (
    <>
      <div className="sticky top-24 z-10 flex items-center lg:container mx-auto px-3 text-gray-100 text-xs mt-24 py-8 bg-primary">
        <div className="flex flex-col items-center active:scale-95 mr-4">
          <div className="w-10 h-10 fill-gray-200">
            <Farmhouse />
          </div>
          <span className="text-xxs mt-2">Farm house</span>
        </div>
        <div className="flex flex-col items-center active:scale-95 mx-4">
          <div className="w-10 h-10 fill-gray-200">
            <Estate />
          </div>
